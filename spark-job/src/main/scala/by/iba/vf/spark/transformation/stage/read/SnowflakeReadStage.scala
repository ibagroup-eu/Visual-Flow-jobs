...
class SnowflakeReadStage(override val configNode: Node, config: SnowflakeStageConfig)
  extends ReadStage(configNode, SnowflakeStageConfig.storageId) {
...
object SnowflakeReadStageBuilder extends ReadStageBuilder {
  ...
  override protected def convert(config: Node): Stage =
    new SnowflakeReadStage(config, new SnowflakeStageConfig(config))
}
